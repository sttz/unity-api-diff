...
public class Object
{
    ...
    static public Object FindObjectOfType(Type type, bool includeInactive);
    static public T FindObjectOfType<T>();
    static public T FindObjectOfType<T>(bool includeInactive);
    static public Object[] FindObjectsOfType(Type type);
    static public Object[] FindObjectsOfType(Type type, bool includeInactive);
    static public T[] FindObjectsOfType<T>();
    static public T[] FindObjectsOfType<T>(bool includeInactive);
