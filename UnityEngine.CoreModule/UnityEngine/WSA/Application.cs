...
public sealed class Application
{
    ...
    static public bool TryInvokeOnAppThread(WSA.AppCallbackItem item, bool waitUntilDone);
    static public bool TryInvokeOnUIThread(WSA.AppCallbackItem item, bool waitUntilDone);
