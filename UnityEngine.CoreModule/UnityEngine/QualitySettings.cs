...
public sealed class QualitySettings : Object
{
    ...
    static public Rendering.RenderPipelineAsset renderPipeline { get; set; }
    ...
    static public SkinWeights skinWeights { get; set; }
    ...
    static public Rendering.RenderPipelineAsset GetRenderPipelineAssetAt(int index);
    static public void IncreaseLevel();
    static public void IncreaseLevel(bool applyExpensiveChanges);
    static public void SetLODSettings(float lodBias, int maximumLODLevel, bool setDirty = true);
