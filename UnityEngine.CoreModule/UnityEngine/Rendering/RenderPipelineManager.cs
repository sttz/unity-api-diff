...
public static class RenderPipelineManager
{
    ...
    static public event Action<Rendering.ScriptableRenderContext, List<Camera>> beginContextRendering;
    ...
    static public event Action<Rendering.ScriptableRenderContext, List<Camera>> endContextRendering;
