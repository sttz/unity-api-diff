...
public static class AsyncGPUReadback
{
    ...
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, ComputeBuffer src, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, GraphicsBuffer src, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, Texture src, int mipIndex = 0, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, Texture src, int mipIndex, Experimental.Rendering.GraphicsFormat dstFormat, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, Texture src, int mipIndex, TextureFormat dstFormat, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, ComputeBuffer src, int size, int offset, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, GraphicsBuffer src, int size, int offset, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, Texture src, int mipIndex, int x, int width, int y, int height, int z, int depth, Experimental.Rendering.GraphicsFormat dstFormat, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeSlice<T>(Unity.Collections.NativeSlice<T> output, Texture src, int mipIndex, int x, int width, int y, int height, int z, int depth, TextureFormat dstFormat, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
