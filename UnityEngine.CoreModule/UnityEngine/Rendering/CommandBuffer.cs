...
public class CommandBuffer : IDisposable
{
    ...
    public void SetBufferData<T>(ComputeBuffer buffer, Unity.Collections.NativeArray<T> data);
    public void SetBufferData<T>(GraphicsBuffer buffer, List<T> data);
    public void SetBufferData<T>(GraphicsBuffer buffer, Unity.Collections.NativeArray<T> data);
    ...
    public void SetBufferData<T>(ComputeBuffer buffer, Unity.Collections.NativeArray<T> data, int nativeBufferStartIndex, int graphicsBufferStartIndex, int count);
    public void SetBufferData<T>(GraphicsBuffer buffer, Unity.Collections.NativeArray<T> data, int nativeBufferStartIndex, int graphicsBufferStartIndex, int count);
