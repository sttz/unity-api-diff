...
public sealed class Shader : Object
{
    ...
    static public int GetGlobalInteger(string name);
    static public int GetGlobalInteger(int nameID);
    ...
    static public void SetGlobalInteger(string name, int value);
    static public void SetGlobalInteger(int nameID, int value);
    ...
    static public void SetGlobalTexture(string name, RenderTexture value, Rendering.RenderTextureSubElement element);
    static public void SetGlobalTexture(int nameID, RenderTexture value, Rendering.RenderTextureSubElement element);
    ...
    public Rendering.ShaderPropertyFlags GetPropertyFlags(int propertyIndex);
    ...
    public Rendering.TextureDimension GetPropertyTextureDimension(int propertyIndex);
