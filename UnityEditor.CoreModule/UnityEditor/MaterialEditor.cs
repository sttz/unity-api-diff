...
public class MaterialEditor : UnityEditor.Editor
{
    ...
    public UnityEditor.ShaderGUI customShaderGUI { get; }
    ...
    public int IntegerProperty(UnityEditor.MaterialProperty prop, string label);
    public int IntegerProperty(Rect position, UnityEditor.MaterialProperty prop, string label);
