...
public class ModelImporter : UnityEditor.AssetImporter
{
    ...
    public UnityEditor.ModelImporterGenerateMaterials generateMaterials { get; }
    ...
    public UnityEditor.ModelImporterMaterialImportMode materialImportMode { get; set; }
    ...
    public UnityEditor.ModelImporterSecondaryUVMarginMethod secondaryUVMarginMethod { get; set; }
