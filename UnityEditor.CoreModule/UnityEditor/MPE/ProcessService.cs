...
public class ProcessService
{
    ...
    static public event Action<int, UnityEditor.MPE.ProcessState> ProcessExitedEvent;
    ...
    static public UnityEditor.MPE.ProcessState GetProcessState(int pid);
    ...
    static public int Launch(string roleName, string[] keyValuePairs);
    ...
    static public void Terminate(int pid);
