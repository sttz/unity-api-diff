...
public sealed class NetworkTransport
{
    ...
    static public bool DoesEndPointUsePlatformProtocols(System.Net.EndPoint endPoint);
    ...
    static public bool IsEncryptionActive();
    static public bool LoadEncryptionLibrary(string libraryName);
    ...
    static public void SetMulticastLock(bool enabled);
    ...
    static public void UnloadEncryptionLibrary();
