...
public class Physics2D
{
    ...
    static public int BoxCast(Vector2 origin, Vector2 size, float angle, Vector2 direction, ContactFilter2D contactFilter, List<RaycastHit2D> results, float distance = ∞);
    ...
    static public int CapsuleCast(Vector2 origin, Vector2 size, CapsuleDirection2D capsuleDirection, float angle, Vector2 direction, ContactFilter2D contactFilter, List<RaycastHit2D> results, float distance = ∞);
    ...
    static public int CircleCast(Vector2 origin, float radius, Vector2 direction, ContactFilter2D contactFilter, List<RaycastHit2D> results, float distance = ∞);
    ...
    static public int GetContacts(Collider2D collider, List<Collider2D> colliders);
    static public int GetContacts(Collider2D collider, Collider2D[] colliders);
    static public int GetContacts(Collider2D collider, List<ContactPoint2D> contacts);
    static public int GetContacts(Collider2D collider, ContactPoint2D[] contacts);
    static public int GetContacts(Rigidbody2D rigidbody, List<Collider2D> colliders);
    static public int GetContacts(Rigidbody2D rigidbody, Collider2D[] colliders);
    static public int GetContacts(Rigidbody2D rigidbody, List<ContactPoint2D> contacts);
    static public int GetContacts(Rigidbody2D rigidbody, ContactPoint2D[] contacts);
    static public int GetContacts(Collider2D collider, ContactFilter2D contactFilter, List<Collider2D> colliders);
    static public int GetContacts(Collider2D collider, ContactFilter2D contactFilter, Collider2D[] colliders);
    static public int GetContacts(Collider2D collider, ContactFilter2D contactFilter, List<ContactPoint2D> contacts);
    static public int GetContacts(Collider2D collider, ContactFilter2D contactFilter, ContactPoint2D[] contacts);
    static public int GetContacts(Rigidbody2D rigidbody, ContactFilter2D contactFilter, List<Collider2D> colliders);
    static public int GetContacts(Rigidbody2D rigidbody, ContactFilter2D contactFilter, Collider2D[] colliders);
    static public int GetContacts(Rigidbody2D rigidbody, ContactFilter2D contactFilter, List<ContactPoint2D> contacts);
    static public int GetContacts(Rigidbody2D rigidbody, ContactFilter2D contactFilter, ContactPoint2D[] contacts);
    static public int GetContacts(Collider2D collider1, Collider2D collider2, ContactFilter2D contactFilter, List<ContactPoint2D> contacts);
    ...
    static public int Linecast(Vector2 start, Vector2 end, ContactFilter2D contactFilter, List<RaycastHit2D> results);
    ...
    static public int OverlapArea(Vector2 pointA, Vector2 pointB, ContactFilter2D contactFilter, List<Collider2D> results);
    ...
    static public int OverlapBox(Vector2 point, Vector2 size, float angle, ContactFilter2D contactFilter, List<Collider2D> results);
    ...
    static public int OverlapCapsule(Vector2 point, Vector2 size, CapsuleDirection2D direction, float angle, ContactFilter2D contactFilter, List<Collider2D> results);
    ...
    static public int OverlapCircle(Vector2 point, float radius, ContactFilter2D contactFilter, List<Collider2D> results);
    ...
    static public int OverlapCollider(Collider2D collider, ContactFilter2D contactFilter, List<Collider2D> results);
    ...
    static public int OverlapPoint(Vector2 point, ContactFilter2D contactFilter, List<Collider2D> results);
    ...
    static public int Raycast(Vector2 origin, Vector2 direction, ContactFilter2D contactFilter, List<RaycastHit2D> results, float distance = ∞);
