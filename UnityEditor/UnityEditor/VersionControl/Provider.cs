...
public class Provider
{
    ...
    static public UnityEditor.VersionControl.Task Checkout(UnityEditor.VersionControl.AssetList assets, UnityEditor.VersionControl.CheckoutMode mode, UnityEditor.VersionControl.ChangeSet changeset);
    static public UnityEditor.VersionControl.Task Checkout(string[] assets, UnityEditor.VersionControl.CheckoutMode mode);
    static public UnityEditor.VersionControl.Task Checkout(string[] assets, UnityEditor.VersionControl.CheckoutMode mode, UnityEditor.VersionControl.ChangeSet changeset);
    static public UnityEditor.VersionControl.Task Checkout(Object[] assets, UnityEditor.VersionControl.CheckoutMode mode);
    static public UnityEditor.VersionControl.Task Checkout(Object[] assets, UnityEditor.VersionControl.CheckoutMode mode, UnityEditor.VersionControl.ChangeSet changeset);
    ...
    static public UnityEditor.VersionControl.Task Checkout(UnityEditor.VersionControl.Asset asset, UnityEditor.VersionControl.CheckoutMode mode, UnityEditor.VersionControl.ChangeSet changeset);
    static public UnityEditor.VersionControl.Task Checkout(string asset, UnityEditor.VersionControl.CheckoutMode mode);
    static public UnityEditor.VersionControl.Task Checkout(string asset, UnityEditor.VersionControl.CheckoutMode mode, UnityEditor.VersionControl.ChangeSet changeset);
    static public UnityEditor.VersionControl.Task Checkout(Object asset, UnityEditor.VersionControl.CheckoutMode mode);
    static public UnityEditor.VersionControl.Task Checkout(Object asset, UnityEditor.VersionControl.CheckoutMode mode, UnityEditor.VersionControl.ChangeSet changeset);
    ...
    static public UnityEditor.VersionControl.Task Internal_ErrorTask(string message);
    static public UnityEditor.VersionControl.Task Internal_WarningTask(string message);
    ...
    static public UnityEditor.VersionControl.Task Merge(UnityEditor.VersionControl.AssetList assets);
    ...
    public delegate bool PreSubmitCallback(UnityEditor.VersionControl.AssetList list, string changesetID, string changesetDescription);

    public delegate bool PreCheckoutCallback(UnityEditor.VersionControl.AssetList list, string changesetID, string changesetDescription);
