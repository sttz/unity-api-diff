...
public sealed class Handles
{
    ...
    static public bool ShouldRenderGizmos();
    ...
    static public void SnapToGrid(Transform[] transforms, SnapAxis axis = 7);
    static public float SnapValue(float value, float snap);
    static public Vector2 SnapValue(Vector2 value, Vector2 snap);
    static public Vector3 SnapValue(Vector3 value, Vector3 snap);
    static public void SphereHandleCap(int controlID, Vector3 position, Quaternion rotation, float size, EventType eventType);
    static public void TransformHandle(Vector3 position, Quaternion rotation);
    static public void TransformHandle(Vector3 position, Quaternion rotation, Vector3 scale);
    static public void TransformHandle(Vector3 position, Quaternion rotation, Vector3 scale);
    static public void TransformHandle(Vector3 position, Quaternion rotation, Vector3 scale);
    static public void TransformHandle(Vector3 position, Quaternion rotation, float uniformScale);
    static public void TransformHandle(Vector3 position, Quaternion rotation, float uniformScale);
    static public void TransformHandle(Vector3 position, Quaternion rotation, float uniformScale);
