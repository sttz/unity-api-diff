...
public static class TerrainLayerUtility
{
    ...
    static public void ShowTerrainLayerGUI(Terrain terrain, TerrainLayer terrainLayer, UnityEditor.Editor terrainLayerEditor, UnityEditor.ITerrainLayerCustomUI customGUI);
