...
public static class UnityEventTools
{
    ...
    static public void AddObjectPersistentListener(Events.UnityEventBase unityEvent, Events.UnityAction<T> call, T argument);
    ...
    static public void AddPersistentListener(Events.UnityEvent<T0> unityEvent, Events.UnityAction<T0> call);
    static public void AddPersistentListener(Events.UnityEvent<T0, T1> unityEvent, Events.UnityAction<T0, T1> call);
    static public void AddPersistentListener(Events.UnityEvent<T0, T1, T2> unityEvent, Events.UnityAction<T0, T1, T2> call);
    static public void AddPersistentListener(Events.UnityEvent<T0, T1, T2, T3> unityEvent, Events.UnityAction<T0, T1, T2, T3> call);
    ...
    static public void RegisterObjectPersistentListener(Events.UnityEventBase unityEvent, int index, Events.UnityAction<T> call, T argument);
    static public void RegisterPersistentListener(Events.UnityEvent unityEvent, int index, Events.UnityAction call);
    static public void RegisterPersistentListener(Events.UnityEvent<T0> unityEvent, int index, Events.UnityAction<T0> call);
    static public void RegisterPersistentListener(Events.UnityEvent<T0, T1> unityEvent, int index, Events.UnityAction<T0, T1> call);
    static public void RegisterPersistentListener(Events.UnityEvent<T0, T1, T2> unityEvent, int index, Events.UnityAction<T0, T1, T2> call);
    static public void RegisterPersistentListener(Events.UnityEvent<T0, T1, T2, T3> unityEvent, int index, Events.UnityAction<T0, T1, T2, T3> call);
    ...
    static public void RemovePersistentListener(Events.UnityEventBase unityEvent, Events.UnityAction<T0> call);
    static public void RemovePersistentListener(Events.UnityEventBase unityEvent, Events.UnityAction<T0, T1> call);
    static public void RemovePersistentListener(Events.UnityEventBase unityEvent, Events.UnityAction<T0, T1, T2> call);
    static public void RemovePersistentListener(Events.UnityEventBase unityEvent, Events.UnityAction<T0, T1, T2, T3> call);
