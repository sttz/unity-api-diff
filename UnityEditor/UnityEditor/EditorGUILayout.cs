...
{
    static public UnityEditor.BuildTargetGroup BeginBuildTargetSelectionGrouping();
    static public bool BeginFadeGroup(float value);
    static public bool BeginFoldoutHeaderGroup(bool foldout, string content, GUIStyle style = null, Action<Rect> menuAction = null, GUIStyle menuIcon = null);
    static public bool BeginFoldoutHeaderGroup(bool foldout, GUIContent content, GUIStyle style = null, Action<Rect> menuAction = null, GUIStyle menuIcon = null);
    ...
    static public void EditorToolbar(UnityEditor.EditorTools.EditorTool[] tools);
    static public void EditorToolbar(System.Collections.Generic.IList<T> tools);
    static public void EditorToolbarForTarget(Object target);
    static public void EditorToolbarForTarget(GUIContent content, Object target);
    static public void EndBuildTargetSelectionGrouping();
    ...
    static public void Space(float width, bool expand);
