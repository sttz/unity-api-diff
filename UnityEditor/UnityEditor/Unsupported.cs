...
public static class Unsupported
{
    ...
    static public string ResolveRedirectedPath(string path);
    static public string ResolveSymlinks(string path);
    static public void RestoreOverrideLightingSettings();
    static public void RestoreOverrideRenderSettings();
    ...
    static public bool SetOverrideRenderSettings(SceneManagement.Scene scene);
    ...
    static public void SetSceneViewDebugModeExposureNoDirty(float exposure);
