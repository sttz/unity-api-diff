...
public sealed class AssetDatabase
{
    ...
    static public void IsOpenForEdit(string[] assetOrMetaFilePaths, System.Collections.Generic.List<string> outNotEditablePaths, UnityEditor.StatusQueryOptions statusQueryOptions = 1);
    ...
    static public bool MakeEditable(string[] paths, string prompt = null, System.Collections.Generic.List<string> outNotEditablePaths = null);
    ...
    static public bool TryGetGUIDAndLocalFileIdentifier(LazyLoadReference<T> assetRef, out string guid, out long localId);
