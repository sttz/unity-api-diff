...
public class EditorUserBuildSettings : Object
{
    ...
    static public bool wsaGenerateReferenceProjects { get; set; }
    static public bool wsaHolographicRemoting { get; set; }
    ...
    static public bool GetWSADotNetNative(UnityEditor.WSABuildType config);
