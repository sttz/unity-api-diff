...
public struct TextureStackRequestHandle<T> : IEquatable<Rendering.VirtualTexturing.Procedural.TextureStackRequestHandle<T>>
{
    ...
    static public void CompleteRequests(Unity.Collections.NativeSlice<Rendering.VirtualTexturing.Procedural.TextureStackRequestHandle<T>> requestHandles, Unity.Collections.NativeSlice<Rendering.VirtualTexturing.Procedural.RequestStatus> status, Rendering.CommandBuffer fenceBuffer);
    ...
    public void CompleteRequest(Rendering.VirtualTexturing.Procedural.RequestStatus status, Rendering.CommandBuffer fenceBuffer);
