...
{
    public XR.InputDeviceCharacteristics characteristics { get; }
    public bool isValid { get; }
    public string manufacturer { get; }
    public string name { get; }
    public XR.InputDeviceRole role { get; }
    public string serialNumber { get; }
    public XR.XRInputSubsystem subsystem { get; }
    ...
    public bool TryGetFeatureUsages(List<XR.InputFeatureUsage> featureUsages);
    public bool TryGetFeatureValue(XR.InputFeatureUsage<bool> usage, out bool value);
    public bool TryGetFeatureValue(XR.InputFeatureUsage<byte[]> usage, byte[] value);
    ...
    public bool TryGetFeatureValue(XR.InputFeatureUsage<bool> usage, DateTime time, out bool value);
    public bool TryGetFeatureValue(XR.InputFeatureUsage<float> usage, DateTime time, out float value);
    public bool TryGetFeatureValue(XR.InputFeatureUsage<uint> usage, DateTime time, out uint value);
    public bool TryGetFeatureValue(XR.InputFeatureUsage<Quaternion> usage, DateTime time, out Quaternion value);
    public bool TryGetFeatureValue(XR.InputFeatureUsage<Vector2> usage, DateTime time, out Vector2 value);
    public bool TryGetFeatureValue(XR.InputFeatureUsage<Vector3> usage, DateTime time, out Vector3 value);
    public bool TryGetFeatureValue(XR.InputFeatureUsage<XR.InputTrackingState> usage, DateTime time, out XR.InputTrackingState value);
