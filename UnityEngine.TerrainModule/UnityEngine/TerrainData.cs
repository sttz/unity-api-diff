...
public sealed class TerrainData : Object
{
    ...
    static public string HolesTextureName { get; }
    ...
    public bool[0...,0...] GetHoles(int xBase, int yBase, int width, int height);
    ...
    public void SetHoles(int xBase, int yBase, bool[0...,0...] holes);
    public void SetHolesDelayLOD(int xBase, int yBase, bool[0...,0...] holes);
