...
public class ListView : Experimental.UIElements.VisualElement
{
    ...
    public ListView();
    public ListView(IList itemsSource, int itemHeight, Func<Experimental.UIElements.VisualElement> makeItem, Action<Experimental.UIElements.VisualElement, int> bindItem);
