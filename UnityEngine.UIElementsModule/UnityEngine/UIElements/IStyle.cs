...
public interface IStyle
{
    ...
    public UIElements.StyleColor borderBottomColor { get; set; }
    ...
    public UIElements.StyleColor borderLeftColor { get; set; }
    public UIElements.StyleFloat borderLeftWidth { get; set; }
    public UIElements.StyleColor borderRightColor { get; set; }
    public UIElements.StyleFloat borderRightWidth { get; set; }
    public UIElements.StyleColor borderTopColor { get; set; }
