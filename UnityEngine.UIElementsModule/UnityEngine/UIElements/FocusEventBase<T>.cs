...
{
    static public T GetPooled(UIElements.IEventHandler target, UIElements.Focusable relatedTarget, UIElements.FocusChangeDirection direction, UIElements.FocusController focusController, bool bIsFocusDelegated = false);
