...
public class NativeInputSystem
{
    ...
    static public Func<UnityEngineInternal.Input.NativeInputUpdateType, bool> onShouldRunUpdate;
    ...
    static public void QueueInputEvent<TInputEvent>(TInputEvent inputEvent);
