...
public class CommandBuffer : IDisposable
{
    ...
    public void RequestAsyncReadbackIntoNativeArray(Unity.Collections.NativeArray<T> output, Texture src, int mipIndex, Experimental.Rendering.GraphicsFormat dstFormat, Action<Rendering.AsyncGPUReadbackRequest> callback);
    public void RequestAsyncReadbackIntoNativeArray(Unity.Collections.NativeArray<T> output, Texture src, int mipIndex, int x, int width, int y, int height, int z, int depth, Action<Rendering.AsyncGPUReadbackRequest> callback);
    ...
    public void SetGlobalFloatArray(string propertyName, System.Collections.Generic.List<float> values);
    public void SetGlobalFloatArray(int nameID, System.Collections.Generic.List<float> values);
    ...
    public void SetGlobalMatrixArray(string propertyName, System.Collections.Generic.List<Matrix4x4> values);
    public void SetGlobalMatrixArray(int nameID, System.Collections.Generic.List<Matrix4x4> values);
    ...
    public void SetGlobalVectorArray(string propertyName, System.Collections.Generic.List<Vector4> values);
    public void SetGlobalVectorArray(int nameID, System.Collections.Generic.List<Vector4> values);
