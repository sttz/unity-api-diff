...
public static class AsyncGPUReadback
{
    ...
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeArray(Unity.Collections.NativeArray<T> output, GraphicsBuffer src, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
    static public Rendering.AsyncGPUReadbackRequest RequestIntoNativeArray(Unity.Collections.NativeArray<T> output, GraphicsBuffer src, int size, int offset, Action<Rendering.AsyncGPUReadbackRequest> callback = null);
