...
public struct PhysicsScene2D : IEquatable<PhysicsScene2D>
{
    ...
    public int BoxCast(Vector2 origin, Vector2 size, float angle, Vector2 direction, float distance, ContactFilter2D contactFilter, System.Collections.Generic.List<RaycastHit2D> results);
    ...
    public int CapsuleCast(Vector2 origin, Vector2 size, CapsuleDirection2D capsuleDirection, float angle, Vector2 direction, float distance, ContactFilter2D contactFilter, System.Collections.Generic.List<RaycastHit2D> results);
    ...
    public int CircleCast(Vector2 origin, float radius, Vector2 direction, float distance, ContactFilter2D contactFilter, System.Collections.Generic.List<RaycastHit2D> results);
    ...
    public int Linecast(Vector2 start, Vector2 end, ContactFilter2D contactFilter, System.Collections.Generic.List<RaycastHit2D> results);
    ...
    public int OverlapArea(Vector2 pointA, Vector2 pointB, ContactFilter2D contactFilter, System.Collections.Generic.List<Collider2D> results);
    ...
    public int OverlapBox(Vector2 point, Vector2 size, float angle, ContactFilter2D contactFilter, System.Collections.Generic.List<Collider2D> results);
    ...
    public int OverlapCapsule(Vector2 point, Vector2 size, CapsuleDirection2D direction, float angle, ContactFilter2D contactFilter, System.Collections.Generic.List<Collider2D> results);
    ...
    public int OverlapCircle(Vector2 point, float radius, ContactFilter2D contactFilter, System.Collections.Generic.List<Collider2D> results);
    ...
    public int OverlapPoint(Vector2 point, ContactFilter2D contactFilter, System.Collections.Generic.List<Collider2D> results);
    ...
    public int Raycast(Vector2 origin, Vector2 direction, float distance, ContactFilter2D contactFilter, System.Collections.Generic.List<RaycastHit2D> results);
