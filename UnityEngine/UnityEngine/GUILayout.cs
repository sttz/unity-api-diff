...
public class GUILayout
{
    ...
    static public int Toolbar(int selected, GUIContent[] contents, bool[] enabled, GUIStyle style, GUILayoutOption[] options);
    static public int Toolbar(int selected, GUIContent[] contents, bool[] enabled, GUIStyle style, ToolbarButtonSize buttonSize, GUILayoutOption[] options);
