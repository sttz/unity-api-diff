...
public sealed class MaterialPropertyBlock
{
    ...
    public void Clear();
    public void CopyProbeOcclusionArrayFrom(System.Collections.Generic.List<Vector4> occlusionProbes);
    public void CopyProbeOcclusionArrayFrom(Vector4[] occlusionProbes);
    public void CopyProbeOcclusionArrayFrom(System.Collections.Generic.List<Vector4> occlusionProbes, int sourceStart, int destStart, int count);
    public void CopyProbeOcclusionArrayFrom(Vector4[] occlusionProbes, int sourceStart, int destStart, int count);
    public void CopySHCoefficientArraysFrom(System.Collections.Generic.List<Rendering.SphericalHarmonicsL2> lightProbes);
    public void CopySHCoefficientArraysFrom(Rendering.SphericalHarmonicsL2[] lightProbes);
    public void CopySHCoefficientArraysFrom(System.Collections.Generic.List<Rendering.SphericalHarmonicsL2> lightProbes, int sourceStart, int destStart, int count);
