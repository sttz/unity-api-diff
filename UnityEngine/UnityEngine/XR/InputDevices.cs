...
{
    static public event Action<XR.InputDevice> deviceConfigChanged;
    ...
    static public void GetDevicesWithCharacteristics(XR.InputDeviceCharacteristics desiredCharacteristics, System.Collections.Generic.List<XR.InputDevice> inputDevices);
